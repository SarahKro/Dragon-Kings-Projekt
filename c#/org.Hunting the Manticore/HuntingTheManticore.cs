...
namespace ieinename
{
    internal class HuntingTheManticore
    {
        static void Main(string[] args)
        {
           ...
           */
            ...
            */
            ...
            Console.WriteLine("Now it's your turn Defender! Guess the distance between the City and the Manticore so we can bring him down! Citys future depends on your decisions! Believe in yourself!(between 0-100)\n");

            for(roundNumber = 1; roundNumber <= cityFullHealth; roundNumber++)
            {
                int cityCurrentHealth = (cityFullHealth + 1) - roundNumber;
                Console.WriteLine($"STATUS: Round: {roundNumber}    City: {cityCurrentHealth}/{cityFullHealth}  Manticore: {manticoreCurrentHealth}/{manticoreFullHealth}");
                ...
                { 
                    Console.ForegroundColor= ConsoleColor.Red;
                    Console.WriteLine("You failed! City has fallen because of YOU! its time to share the same fate as the every other fallen civillian in the City.. Bäm!");
                    Console.ForegroundColor = ConsoleColor.White;
                    break ;
                }
        ...
        /*
        private static string ZamHängen(string v1, string v2)
        {
            return v1 + v2;
        }
        ...
        static int AskForNumberInRange(string text, int min, int max)
        {
            ...
            while (true)
            {
                ...
                string ask = "";
                ask = ZamHängen2("that can't be possible,", " please give an other number");
        ...
        private static string ZamHängen2(string v1, string v2)
        {
